...
![]({{ site.url }}/images/Image%202013.08.14%2016_09_33.jpeg)
...
![A diagram of the scrolling problem on the X-axis]({{ site.url }}/images/Image%202013.08.14%2016_03_57.png)

Second a diagram of the problem on the Y-axis:

![A diagram of the scrolling problem on the Y-axis]({{ site.url }}/images/Image%202013.08.14%2016_04_26.png)

---

**Figure 1** - The default state. This is before we've interacted with the page at all.

![Figure 1 - The default state]({{ site.url }}/images/Image%202013.08.14%2016_05_25.png)
...
![Figure 2 - Viewport bias]({{ site.url }}/images/Image%202013.08.14%2016_06_09.png)
...
![Figure 3 - Viewport bias]({{ site.url }}/images/Image%202013.08.14%2016_07_20.png)

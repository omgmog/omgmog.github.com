...
I've been learning Objective-C along with [@tmayr](http://tmayr.tumblr.com), so far covering just basic things such as processing user input and displaying output, using Cocoa/Interface Builder.
